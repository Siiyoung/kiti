...
public class AssertCopy {
    ...
    public AssertCopy( Context context ) {
            mContext = context;
     ...
     *  @throws IOException
     */
    protected static List<String> getAssetsList() throws IOException {
     ...
     *  @throws IOException
     */
    protected static File copy( String asset ) throws IOException {
